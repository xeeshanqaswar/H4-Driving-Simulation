...
public class CarControlCS : MonoBehaviour
{
    ...
    public Button leftPedal;
    public Button rightPedal;
    public Button handBreakPedal;
    ...
    void GUIButtonControl()
    {
        ...
        if (mobileInput)
        {
            ...
            handBreakPedal.gameObject.SetActive(true);
        }
        else
        {
            ...
            handBreakPedal.gameObject.SetActive(false);
        }
    }
    ...
    void DriveMobile()
    {
        ...
        //when the Brake and Gas  button is released, slow the car down
        if (!brakePedal.Pressed && !gasPedal.Pressed)
        {
            throttleInput = 0;
        }

        //now the left steering column...
        if (leftPedal.Pressed)
        {
        ...
        if (!rightPedal.Pressed && !leftPedal.Pressed)
        {
            steerInput = 0;
        }
        ...
        if (handBreakPedal.Pressed)//pressing handBrakePedal triggers the car's handbrake
        {
        ...
        else//letting go of handBrakePedal disables the handbrake
        {
